  ...
  return (
    <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-6">
      ...
      <p className="mb-6 text-sm text-[rgb(var(--muted))]">
        Sign in to your PostUp account.
      </p>
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-xs text-[rgb(var(--muted))]">
          <span className="bg-[rgb(var(--card))] px-2">or continue with</span>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--bg))] px-4 py-2 text-sm font-medium text-[rgb(var(--fg))] hover:bg-[rgb(var(--card))] transition-colors"
        >
          <GitHubIcon />
